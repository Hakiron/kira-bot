import random
import disnake
from disnake.ext import commands, tasks  # <-- Добавили "tasks" для таймера
...
# Ты можешь добавлять сюда любые свои фразы и смайлики через запятую
BOT_STATUSES = [
...
async def change_status_daily():
    ...
    # Выбираем случайный статус из нашего списка BOT_STATUSES
    new_status = random.choice(BOT_STATUSES)

    # Меняем статус бота в Дискорде
